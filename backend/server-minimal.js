/**
 * Minimal Socio.io Content Moderation Backend Server
 * This Express server provides the most basic functionality for testing.
 */
...
// Root endpoint
app.get('/', (req, res) => {
  res.send('Socio.io Backend Server is running!');
});
